    ...
    <div className="auth-page-shell">
      <div className="auth-shell-grid auth-shell-login">
        ...
        <section className="auth-card">
          ...
          <GoogleAuthButton onCredential={onGoogleCredential} onUnavailable={(message) => toast(message || "Google sign-in could not be opened.")} disabled={googleBusy || submitting} />
