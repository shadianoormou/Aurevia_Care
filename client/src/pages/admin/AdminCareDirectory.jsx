...
const blankEntry = () => ({ kind: "doctor", name: "", specialty: "", conditions: "", division: "", district: "", upazila: "", country: "Bangladesh", address: "", phone: "", email: "", availability: "", verificationNote: "", sourceLabel: "", sourceUrl: "", lastVerifiedAt: new Date().toISOString().slice(0, 10), isPublished: true });
const fromEntry = (entry) => ({ ...entry, division: entry.location?.division || "", district: entry.location?.district || "", upazila: entry.location?.upazila || "", country: entry.location?.country || "Bangladesh", conditions: (entry.conditions || []).join(", "), lastVerifiedAt: String(entry.lastVerifiedAt || "").slice(0, 10) });
